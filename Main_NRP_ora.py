...
with open(r"sprint_hint01.dat", 'r') as file:
...
#while count_random <= (n_days+1)-optTime_random:
...
print(f"Running time random: {endTime_random-startTime_random}\n")

objValue.sort(reverse=True)
print(f"Greedy obj. value: {objValue[-1]}")
print(f"Running time greedy: {endTime-startTime}")
